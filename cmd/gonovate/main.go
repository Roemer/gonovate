...
var commands = []Command{
	{Name: "help", Help: "Prints this help", Run: cli.HelpCmd},
	{Name: "run", Help: "Runs the gonovate process", Run: cli.RunCmd},
	{Name: "debug", Help: "Tools usefull for/while debugging", Run: cli.DebugCmd},
}
