...
import (
	...
	"github.com/roemer/gonovate/internal/datasources"
...
type IManager interface {
	...
	getChanges(mergedManagerSettings *config.ManagerSettings, possiblePackageRules []*config.Rule) ([]core.IChange, error)
