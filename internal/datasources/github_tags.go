...
func NewGitHubTagsDatasource(logger *slog.Logger, config *config.Config) IDatasource {
...
func (ds *GitHubTagsDatasource) getReleases(packageSettings *config.PackageSettings) ([]*core.ReleaseInfo, error) {
