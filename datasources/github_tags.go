...
func NewGitHubTagsDatasource(logger *slog.Logger) IDatasource {
...
func (ds *GitHubTagsDatasource) getReleases(packageSettings *core.PackageSettings, hostRules []*core.HostRule) ([]*core.ReleaseInfo, error) {
